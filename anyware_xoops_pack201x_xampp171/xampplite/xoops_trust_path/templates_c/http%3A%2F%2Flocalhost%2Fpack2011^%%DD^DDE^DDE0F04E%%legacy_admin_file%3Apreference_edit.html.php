<?php /* Smarty version 2.6.26, created on 2012-03-22 18:03:35
         compiled from file:preference_edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'xoops_escape', 'file:preference_edit.html', 3, false),array('function', 'xoops_token', 'file:preference_edit.html', 36, false),array('function', 'xoops_input', 'file:preference_edit.html', 37, false),array('function', 'cycle', 'file:preference_edit.html', 57, false),array('function', 'xoops_textarea', 'file:preference_edit.html', 59, false),array('function', 'xoops_optionsArray', 'file:preference_edit.html', 98, false),)), $this); ?>
<div class="adminnavi">
...
">
          ...
          <?php elseif ($this->_tpl_vars['config']->get('conf_formtype') == 'server_module'): ?>
...
' <?php if ($this->_tpl_vars['actionForm']->get($this->_tpl_vars['config']->get('conf_name')) == $this->_tpl_vars['option']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['option']; ?>
</option>
              <?php endforeach; endif; unset($_from); ?>
            </select>
...
" <?php if ($this->_tpl_vars['flag']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['option']->getOptionLabel())) ? $this->_run_mod_handler('xoops_escape', true, $_tmp) : smarty_modifier_xoops_escape($_tmp)); ?>
          ...
          <?php elseif ($this->_tpl_vars['config']->get('conf_formtype') == 'yesno'): ?>
                        <label><?php echo smarty_function_xoops_input(array('type' => 'radio','name' => $this->_tpl_vars['config']->get('conf_name'),'value' => 1,'default' => $this->_tpl_vars['actionForm']->get($this->_tpl_vars['config']->get('conf_name'))), $this);?>
<?php echo @_YES; ?>
</label>
            <label><?php echo smarty_function_xoops_input(array('type' => 'radio','name' => $this->_tpl_vars['config']->get('conf_name'),'value' => 0,'default' => $this->_tpl_vars['actionForm']->get($this->_tpl_vars['config']->get('conf_name'))), $this);?>
<?php echo @_NO; ?>
</label>
