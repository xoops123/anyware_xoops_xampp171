<?php /* Smarty version 2.6.26, created on 2012-03-22 16:55:19
         compiled from blocks/legacy_admin_block_sidemenu.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'theme', 'blocks/legacy_admin_block_sidemenu.html', 5, false),array('modifier', 'xoops_escape', 'blocks/legacy_admin_block_sidemenu.html', 6, false),)), $this); ?>
<?php $_from = $this->_tpl_vars['modules']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['module']):
?>

  <?php if ($this->_tpl_vars['module']->hasAdminIndex()): ?>
    <div id="t<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('mid'); ?>
" class="head">
      <a href="javascript:void(0)" onclick="ccToggle(<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('mid'); ?>
)"><img src="<?php echo ((is_array($_tmp="design/max.png")) ? $this->_run_mod_handler('theme', true, $_tmp) : Legacy_modifier_theme($_tmp)); ?>
" alt="" id="i<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('mid'); ?>
" /></a>
...
"><?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('name'); ?>
</a>
    </div>

    <div id="c<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('mid'); ?>
" class="submenu">
      <ul>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['menu']['title'])) ? $this->_run_mod_handler('xoops_escape', true, $_tmp) : smarty_modifier_xoops_escape($_tmp)); ?>
        ...
        <?php endforeach; endif; unset($_from); ?>
          ...
          <?php if ($this->_tpl_vars['module']->mXoopsModule->getInfo('blocks') && $this->_tpl_vars['module']->mXoopsModule->getShow('dirname') != 'legacy' && $this->_tpl_vars['module']->mXoopsModule->getShow('dirname') != 'altsys' && $this->_tpl_vars['module']->mXoopsModule->getShow('dirname') != 'system'): ?>
          <li>
          <a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacy/admin/index.php?action=BlockList&amp;dirname=<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('dirname'); ?>
">
...
" alt="" title="" />&nbsp;
          ...
          <li>
          <a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacy/admin/index.php?action=BlockInstallList&amp;dirname=<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('dirname'); ?>
">
...
" alt="" title="" />&nbsp;
          ...
          <?php if ($this->_tpl_vars['module']->mXoopsModule->getShow('dirname') != 'legacyRender' && $this->_tpl_vars['module']->mXoopsModule->getShow('dirname') != 'altsys' && $this->_tpl_vars['module']->mXoopsModule->getShow('dirname') != 'system'): ?>
...
?>
          <?php if ($this->_tpl_vars['module']->mXoopsModule->getShow('dirname') == $this->_tpl_vars['tplmodule']): ?>			
          <li>
          <a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacyRender/admin/index.php?action=TplfileList&amp;tpl_module=<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('dirname'); ?>
&amp;sort=-9">
...
" alt="" title="" />&nbsp;
          ...
          <li>
          <a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacy/admin/index.php?action=CommentList&amp;com_modid=<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('mid'); ?>
&amp;sort=-8">
...
" alt="" title="" />&nbsp;
          ...
          <li>
          <a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacy/admin/index.php?action=ModuleUpdate&amp;dirname=<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('dirname'); ?>
">
...
/modules/legacy/admin/index.php?action=ModuleEdit&amp;mid=<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('mid'); ?>
">
...
" alt="" title="" />&nbsp;
          ...
          <li>
          <a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacy/admin/index.php?action=ModuleInfo&amp;dirname=<?php echo $this->_tpl_vars['module']->mXoopsModule->getShow('dirname'); ?>
">
