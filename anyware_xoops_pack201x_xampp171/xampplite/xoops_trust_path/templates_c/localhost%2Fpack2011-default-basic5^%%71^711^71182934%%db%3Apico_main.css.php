<?php /* Smarty version 2.6.26, created on 2012-03-22 21:23:45
         compiled from db:pico_main.css */ ?>
...
div.pico_controllers_in_menu { float: <?php echo @_ALIGN_END; ?>
; position: relative; top : -1.5em;}

div.bottom_of_content_body { clear: <?php echo @_ALIGN_END; ?>
; }

ul.pico_list_contents li { list-style: none outside; }
ul.pico_list_contents_in_menu li { list-style: none outside; }

div.pico_print_icon { float: <?php echo @_ALIGN_END; ?>
; width: 40px; height: 40px; }
div.pico_tellafriend_icon { float: <?php echo @_ALIGN_END; ?>
; width: 40px; height: 40px; }
...
table.pico_form_table th{
        ...
        text-align                      :<?php echo @_ALIGN_START; ?>
;}
p.pico_submit{
        text-align                      :center;
        margin                          :0;
...
input.pico_number_only { ime-mode: disabled; text-align: <?php echo @_ALIGN_END; ?>
; }
