<?php /* Smarty version 2.6.26, created on 2012-03-22 16:55:15
...
<?php echo Legacy_function_stylesheet(array('file' => "style.css"), $this);?>

<?php echo Legacy_function_stylesheet(array('file' => "module.css"), $this);?>
...
<noscript>
  <div id="menunavi">
  <h2><?php echo $this->_tpl_vars['currentModule']->mXoopsModule->getShow('name'); ?>
</h2>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['menu']['title'])) ? $this->_run_mod_handler('xoops_escape', true, $_tmp) : smarty_modifier_xoops_escape($_tmp)); ?>
      ...
      <?php endforeach; endif; unset($_from); ?>
          ...
          <?php if ($this->_tpl_vars['currentModule']->mXoopsModule->getInfo('blocks') && $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname') != 'legacy' && $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname') != 'altsys' && $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname') != 'system'): ?>
...
/modules/legacy/admin/index.php?action=BlockList&amp;dirname=<?php echo $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname'); ?>
"><?php echo @_MI_LEGACY_MENU_BLOCKLIST; ?>
</a></li>
          <li><img src="<?php echo ((is_array($_tmp="icons/upgrade.png")) ? $this->_run_mod_handler('theme', true, $_tmp) : Legacy_modifier_theme($_tmp)); ?>
" alt="" title="" />&nbsp;<a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacy/admin/index.php?action=BlockInstallList&amp;dirname=<?php echo $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname'); ?>
"><?php echo @_MI_LEGACY_MENU_BLOCKINSTALL; ?>
</a></li>
          <?php endif; ?>
          <?php if ($this->_tpl_vars['currentModule']->mXoopsModule->getInfo('templates') && $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname') != 'legacyRender' && $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname') != 'altsys' && $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname') != 'system'): ?>
          <li><img src="<?php echo ((is_array($_tmp="icons/upgrade.png")) ? $this->_run_mod_handler('theme', true, $_tmp) : Legacy_modifier_theme($_tmp)); ?>
" alt="" title="" />&nbsp;<a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacyRender/admin/index.php?action=TplfileList&amp;tpl_module=<?php echo $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname'); ?>
&amp;sort=-9"><?php echo @_AD_LEGACY_LANG_TEMPLATE_INFO; ?>
          ...
          <li><img src="<?php echo ((is_array($_tmp="icons/upgrade.png")) ? $this->_run_mod_handler('theme', true, $_tmp) : Legacy_modifier_theme($_tmp)); ?>
" alt="" title="" />&nbsp;<a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacy/admin/index.php?action=CommentList&amp;com_modid=<?php echo $this->_tpl_vars['currentModule']->mXoopsModule->getShow('mid'); ?>
...
/modules/legacy/admin/index.php?action=ModuleUpdate&amp;dirname=<?php echo $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname'); ?>
...
" />&nbsp;<?php echo @_AD_LEGACY_LANG_UPGRADE; ?>
        ...
        <?php endif; ?>
          <li><img src="<?php echo ((is_array($_tmp="icons/upgrade.png")) ? $this->_run_mod_handler('theme', true, $_tmp) : Legacy_modifier_theme($_tmp)); ?>
" alt="" title="" />&nbsp;<a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacy/admin/index.php?action=ModuleEdit&amp;mid=<?php echo $this->_tpl_vars['currentModule']->mXoopsModule->getShow('mid'); ?>
"><?php echo @_EDIT; ?>
</a></li>
          <li><img src="<?php echo ((is_array($_tmp="icons/upgrade.png")) ? $this->_run_mod_handler('theme', true, $_tmp) : Legacy_modifier_theme($_tmp)); ?>
" alt="" title="" />&nbsp;<a href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/legacy/admin/index.php?action=ModuleInfo&amp;dirname=<?php echo $this->_tpl_vars['currentModule']->mXoopsModule->getShow('dirname'); ?>
...
<div id="footer">Powered by&nbsp;<?php echo @XOOPS_VERSION; ?>
 &copy; 2001-2009 <a href="http://sourceforge.net/projects/xoopscube/" rel="external">The XOOPS Cube Project<br />
